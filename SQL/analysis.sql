...
DENSE_RANK() OVER (PARTITION BY r.city ORDER BY COUNT(o.order_item) DESC) AS rnk
...
SELECT DISTINCT c.customer_name, c.customer_id  FROM customers c JOIN orders o
ON c.customer_id=o.customer_id 
WHERE EXTRACT(YEAR FROM o.order_date)=2023 AND c.customer_name NOT IN (
